...
export default function PdfToExcel() {
  ...
  const convert = async () => {
    ...
    try {
      ...
      const res = await fetch(base + "/pdf-to-excel", {
        method: "POST",
        body: form,
      });
      ...
      const safeName =
        file.name.replace(/\.pdf$/i, "") || "pdf_to_excel";
      a.href = url;
    ...
    <div style={styles.page}>
      <div style={styles.card}>
        <div style={styles.header}>
          <h1 style={styles.title}>PDF → Excel</h1>
          <p style={styles.subtitle}>
            Convert table-based PDFs into editable Excel spreadsheets — great
            for invoices, reports, and data tables.
          </p>
        </div>
        ...
        <div style={styles.uploadBox}>
          ...
          <div style={styles.actions}>
            ...
            >
              {loading ? <Loader /> : "Convert to Excel"}
            </button>
          </div>
...
if (typeof window !== "undefined") {
  const styleId = "pdf-to-excel-loader-style";
