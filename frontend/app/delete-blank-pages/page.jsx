...
export default function DeleteBlankPages() {
  ...
  const convert = async () => {
    ...
    try {
      ...
      const res = await fetch(base + "/delete-blank-pages", {
        method: "POST",
        body: form,
      });
      ...
      a.href = url;
      a.download = `${file.name.replace(/\.pdf$/i, "")}_no_blank.pdf`;
    ...
    <div style={styles.page}>
      <div style={styles.card}>
        <div style={styles.header}>
          <h1 style={styles.title}>Delete Blank Pages</h1>
          <p style={styles.subtitle}>
            Remove blank pages from your PDF — fast & private.
          </p>
        </div>
        ...
        <div style={styles.actions}>
          ...
          >
            {loading ? "Working…" : "Remove Blank Pages"}
          </button>
        </div>
        ...
        <div style={styles.note}>
          Note: This removes pages that have no text. Scanned image “blank” pages need OCR (we’ll add later).
        </div>
      </div>
    </div>
  );
