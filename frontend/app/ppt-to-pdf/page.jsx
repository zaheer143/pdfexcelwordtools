...
export default function PptToPdf() {
  ...
  const convert = async () => {
    if (!file) return alert("Please upload a PPT or PPTX file");
    ...
    try {
      ...
      const res = await fetch(base + "/ppt-to-pdf", {
        method: "POST",
        body: form,
      });
      ...
      const safeName =
        file.name.replace(/\.(pptx?|PPTX?)$/, "") || "ppt_to_pdf";
      a.href = url;
    ...
    <div style={styles.page}>
      <div style={styles.card}>
        <div style={styles.header}>
          <h1 style={styles.title}>PPT → PDF</h1>
          <p style={styles.subtitle}>
            Convert your PowerPoint presentations (.ppt, .pptx) into shareable
            PDF files — fast &amp; private.
          </p>
        </div>
...
if (typeof window !== "undefined") {
  const styleId = "ppt-to-pdf-loader-style";
