...
export default function GrayscalePdf() {
  ...
  const convert = async () => {
    ...
    try {
      ...
      const res = await fetch(base + "/grayscale-pdf", { method: "POST", body: form });
    ...
    <div style={styles.page}>
      <div style={styles.card}>
        <div style={styles.header}>
          <h1 style={styles.title}>Grayscale PDF</h1>
          <p style={styles.subtitle}>Convert PDF to black & white for cheaper printing and smaller size.</p>
        </div>
        ...
        <div style={styles.uploadBox}>
          ...
          <div style={styles.actions}>
            ...
            <button onClick={convert} style={styles.convertBtn} disabled={loading || !file}>
              {loading ? <Loader /> : "Convert to Grayscale"}
            </button>
          </div>
...
if (typeof window !== "undefined") {
  const styleId = "grayscale-pdf-loader-style";
