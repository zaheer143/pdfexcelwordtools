...
export default function PdfToPng() {
  ...
  const convert = async () => {
    ...
    try {
      ...
      const res = await fetch(base + "/pdf-to-png", {
        method: "POST",
        body: form,
      });
      ...
      a.href = url;
      a.download = `${file.name.replace(/\.pdf$/i, "")}_png.zip`;
    ...
    <div style={styles.page}>
      <div style={styles.card}>
        <div style={styles.header}>
          <h1 style={styles.title}>PDF → PNG</h1>
          <p style={styles.subtitle}>
            Convert each page of your PDF into high-quality PNG images — fast & private.
          </p>
        </div>
...
if (typeof window !== "undefined") {
  const id = "pdf-to-png-loader-style";
