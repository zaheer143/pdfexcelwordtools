...
export default function PdfToPdfA() {
  ...
  const convert = async () => {
    ...
    try {
      ...
      const res = await fetch(base + "/pdf-to-pdfa", {
        method: "POST",
        body: form,
      });
      ...
      console.error("PDF→PDF/A error:", err);
    ...
    <div style={styles.page}>
      <div style={styles.card}>
        <div style={styles.header}>
          <h1 style={styles.title}>PDF → PDF/A</h1>
          <p style={styles.subtitle}>
            Convert PDF to ISO-compliant PDF/A for archiving & government submission.
          </p>
        </div>
        ...
        <div style={styles.uploadBox}>
          ...
          <div style={styles.actions}>
            ...
            <button onClick={convert} style={styles.convertBtn} disabled={loading || !file}>
              {loading ? <Loader /> : "Convert to PDF/A"}
            </button>
          </div>
...
// Inject keyframes (same pattern you used)
if (typeof window !== "undefined") {
  const styleId = "pdf-to-pdfa-loader-style";
