...
export default function FlattenPdf() {
  ...
  const convert = async () => {
    ...
    try {
      ...
      const res = await fetch(base + "/flatten-pdf", { method: "POST", body: form });
    ...
    <div style={styles.page}>
      <div style={styles.card}>
        <div style={styles.header}>
          <h1 style={styles.title}>Flatten PDF</h1>
          <p style={styles.subtitle}>Make your PDF non-editable (flatten forms & annotations).</p>
        </div>
